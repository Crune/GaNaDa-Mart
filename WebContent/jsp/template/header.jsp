	...
	<nav class="global_gnb">
		...
		<div class="global_gnb_top">
			...
			<div class="global_right_nav">
				<ul>
					<li class="global_login"><a href="#">
							<span>회원가입 / 로그인</span>
						</a></li>
					<li class="global_help"><a href="mainCustomer.gnd">
							<span>고객센터</span>
						</a>
						<ul class="global_help_menu" style="display: none;">
							...
							<li class="gb_help_list_all"><a href="./helpdesk/mainCustomer.gnd">전체보기</a></li>
						</ul></li>
					<li class="cart"><a href="./cart.gnd">
							<span>장바구니</span> <span class="count" id="cartBubble" style="display: none;">0</span>
						</a></li>
				</ul>
			</div>
		</div>
					...
					<menu:getChild code="0" type="0">
						<c:forEach var="d1" items="${ChildMenu}">
							<div class="global_depth1 men">
								<span></span>
								<a href="./page.gnd?code=${d1.target}">
									<span>${d1.name}</span>
								</a>
							</div>
										...
										<div class="global_sub_menu">
											...
											<menu:getChild code="${d1.code}" type="0">
												<c:forEach var="d2" items="${ChildMenu}">
													<div class="global_category_h3">
														<div>
															<div class="global_category_stit">
																<a href="./type.gnd?code=${d2.target}">${d2.name}</a>
																<span class="ico"></span>
															</div>
															<ul>
																<!-- 3단계 반복 시작 -->
