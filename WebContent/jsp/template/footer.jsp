		...
		<div class="global_info_cont2">
			<div class="global_info_cont2_inner">
				<ul>
					...
					<li>통신판매업신고번호 : 2011-서울강남-03461&nbsp;&nbsp;/&nbsp;&nbsp;등록번호 :
						220-88-09068 <a
						href="http://www.ftc.go.kr/info/bizinfo/communicationList.jsp"
						target="_blank" title="새창열림">사업자정보확인</a>
					</li>
					<li>개인정보관리책임자 : 정찬우&nbsp;&nbsp;&nbsp;&nbsp;정보보호최고책임자 :
						주보형&nbsp;&nbsp;&nbsp;&nbsp;대표번호 : 010-000-0000</li>
					<li>FAX : 02-0000-0000&nbsp;&nbsp;&nbsp;&nbsp;E-mail :
						service@ganada.co.kr&nbsp;&nbsp;&nbsp;&nbsp;호스팅서비스사업자 : 아마존</li>
				</ul>
				<ul>
							...
							<div class="global_guide_layer">
								<div class="global_guide_inner">
									...
									<div>
										...
										<p>
											콘텐츠의 제작자 : ㈜롯데닷컴 서울시 중구 을지로 158 10층(을지로4가 삼풍빌딩)<br> <span
												style="padding-left: 88px">TEL : 02-0000-0000, FAX :
												02-3668-8501</span>
										</p>
										<p>
											<span>카 홈페이지 내의 모든 콘텐츠는「콘텐츠산업 진흥법」에 따라 제작일 또는</span><br>
											<span>그 갱신일로부터 5년간 보호됩니다.(동의 없는 무단 복제를 금함)</span>
										</p>
									</div>
