		...
		<div class="contents">
			<form method="post" name="frmJoin" id="frmJoin">
				...
				<div class="sectionL">
					...
					<p class="txt05 mt20">나이키닷컴의 회원가입 요청을 감사드립니다.<br> 본인인증을 위하여 ddd@dd.com 로 인증메일을 발송하였으니, <br> 24시간 이내에 꼭 확인해 주세요.
					</p>
					<div class="alL mt40">
						<a href="#" onclick="goLoginPage();" class="btn-type1 btn-black">
							<span class="right">확인</span>
						</a>
					</div>
				</div>
				<!-- // .sectionL -->
				<div class="sectionR02">
					<div class="desc">
						인증메일의 “본인인증하기” 버튼을 클릭하시면 <br> 나이키닷컴 회원가입이 최종 완료되며, <br> 쿠폰/이벤트 등 각종 회원 혜택을 이용하실 수 있습니다.<br>
						<br> <strong>본인인증은 24시간 이내에 반드시 해주셔야 합니다.</strong><br> 24시간이 지나면 본인인증이 불가하며, 회원가입을 위하여 <br> 다시 회원가입 요청을 진행해 주셔야 합니다.
					</div>
				</div>
				<!-- // .sectionR -->
