...
<div class="popLayer">
    ...
    <div class="contents">
              ...
              <col style="width:650px;">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p class="mt10"><input type="checkbox" id="chkEmail" name="chkEmail" checked="checked">
                    <label class="checkType01" for="chkEmail">서비스 및 이벤트 소식이 담긴 Nike 이메일을 수신하겠습니다.</label></p>
                ...
                <tr>
                  ...
                  <td><input type="password" style="width:195px;" name="repwd" id="repwd" maxlength="12" onkeyup="passwordCheck(this);"></td>
                </tr>
                <tr>
      ...
      <div class="alR mt20">
        <a href="#none" onclick="memberJoin();" class="btn-type1 btn-orange"><span class="right">가입하기</span></a>
