...
function send(){
    ...
    if(frmAgree.agree.checked == false){
        window.alert("약관에 동의하신 후 회원가입이 가능합니다");
        return false;
    }else{
        return true;
    }
...
<form name="frmAgree" 
      method="post" 
      action="./create_form.jsp" 
      onsubmit="return send()">

<div style="text-align: center">약관동의</div>

<table border="0" cellspacing="0" cellpadding="2"  align="center">
    <tr align="center" height="10"> 
        <td>
            <textarea cols="80" rows="14">Cummunity 서비스약관 (2005. 7. 18 부터 유효)
제1조(목적 등)
...
<div style="text-align: center">
    ...
    <input type="button" value="취소" onclick="javascript:history.back();"></input>
</div>
