...
<style type="text/css">
        ...
        #header {
            width:100%; height:50px; background-color:#FFFFFF; border:groove 1px silver;
            padding:5px 5px 5px 5px; margin:0px 0px 10px 0px; text-align:left;}            
        #left{
            width:10%; height:300px; background-color:#FFFFFF; border:groove 1px silver;
            padding:5px 5px 5px 5px; margin:0px 10px 0px 0px; float:left;}        
        #content{
            width:50%; height:300px; background-color:#FFFFFF; border:groove 1px silver;
            padding:5px 5px 5px 5px; margin:0px 0px 0px 0px;
            float:left;} 
        #right{
            width:30%; height:300px; background-color:#FFFFFF; border:groove 1px silver;
            padding:5px 5px 5px 5px; margin:0px 0px 0px 10px; text-align:left; float:left;}
        #footer{
            clear:both;
            width:100%; height:100px; background-color:#FFFFFF; border:groove 1px silver;
